...
Potree.ProfileTool = class ProfileTool extends THREE.EventDispatcher{
	...
	constructor(viewer){
		...
		this.viewer.inputHandler.registerInteractiveScene(this.sceneProfile);//XL-an array (list in python)- interactiveScenes[sceneProfile]
	...
	startInsertion(args = {}){
		//XL-the canvas where sence will be drawn, the index.html file
		let domElement = this.viewer.renderer.domElement;
		
		//XL-create profile class
